...
async function main() {
    try {
        ...
        const walletPath = '../SafeRecords/javascript/wallet';
        ...
        const contract = network.getContract('SafeRecords');

        // Evaluate the specified transaction.
        // queryDocument transaction - requires 1 argument, ex: ('queryDocument', 'ID' , 'UserName')
        ...
        if (ID === "-1") {
            ...
            const result = await contract.evaluateTransaction('queryDocument', ID);
